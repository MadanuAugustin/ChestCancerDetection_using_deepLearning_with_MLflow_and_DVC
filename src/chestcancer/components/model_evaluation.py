...
from chestcancer import logger, CustomException
...
class Evaluation:
    ...
    def evaluation(self):
        ...
        try:
            ...
            os.environ["MLFLOW_TRACKING_URI"]='https://dagshub.com/augustin7766/ChestCancerDetection_using_deepLearning_with_MLflow_and_DVC.mlflow'
